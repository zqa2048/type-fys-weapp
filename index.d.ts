export namespace Yfs {
    /**
     * name : IYfsActivitie
     */
    interface IYfsActivitie {
        /**
         * 活动名称
         */
        activityName: string;
